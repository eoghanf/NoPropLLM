...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Train model on MNIST dataset using backpropagation",
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None,
        help="Path to YAML configuration file (default: experiment_configs/mnistbackpropagation.yaml)"
    )
